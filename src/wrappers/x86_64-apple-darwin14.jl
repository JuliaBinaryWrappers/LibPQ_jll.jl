# Autogenerated wrapper script for LibPQ_jll for x86_64-apple-darwin14
export LIBPQ_HANDLE
...
const LIBPQ_HANDLE_splitpath = ["lib", "libpq.5.12.dylib"]
...
const LIBPQ_HANDLE = "@rpath/libpq.5.dylib"
