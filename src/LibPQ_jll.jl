...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LibPQ_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("08be9ffa-1c94-5ee5-a977-46a84ec9b350"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LibPQ", artifacts_toml) for e in artifacts["LibPQ"]]
...
if best_platform === nothing
    @debug("Unable to load LibPQ; unsupported platform $(triplet(platform_key_abi()))")
else
